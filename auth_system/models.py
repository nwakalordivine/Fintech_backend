...
class CustomUserManager(BaseUserManager):
    def create_user(self, email, firstname=None, lastname=None, password=None, phone_number=None, image=None, is_staff=False, is_admin=False, is_superuser=False, date_of_birth=None):
        if not email:
...
class User(AbstractBaseUser):
    ...
    bvn = models.CharField(null=True, blank=True, max_length=10, unique=True)
